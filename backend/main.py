...
from app.routes.auth_resource import LoginResource, RefreshTokensResource, LogoutResource
from app.routes.resource import UserResource, ActivationUserResource, UserMeResource
