...
export default function TopBar(){
    return (
        <header className="bg-black w-[95vw] md:w-[80vw] lg:w-[70vw] h-12 flex items-center rounded-[1vw] m-4 text-white text-center">
            ...
            <div className="w-full h-full flex flex-row items-center justify-end">
                <div className="hover:bg-gray-700 hidden md:block md:w-[15vw] lg:w-[15vw]">
                ...
                <div className="w-[20vw] md:w-[10vw] bg-white text-black rounded-2xl mr-2">
